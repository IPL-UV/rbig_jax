...
parser.add_argument(
    "--n_samples", type=int, default=10_000, help="number of data points for training",
)
...
parser.add_argument(
    "--n_layers", type=int, default=4, help="Standardize Input Training Data"
)
parser.add_argument(
...
parser.add_argument(
    "--learning_rate", type=float, default=0.01, help="Number of batches"
)
# ======================
# Logger Parameters
# ======================
